...
main(int argc, char* argv[])
{
  ...
  if (argc == 2) {
    ...
    ********************************************************/
    ...
    std::string output = course.transform([](const Course& c){return "Found course: "+c.title+","+c.number_of_units+","+c.quarter;}).or_else([](){return std::optional<std::string>("Course not found.");}).value();
    /********************************************************
